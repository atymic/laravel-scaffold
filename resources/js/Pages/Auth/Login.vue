<template>
  <div class="p-6 bg-primary-800 min-h-screen flex justify-center items-center">
    <div class="w-full max-w-md">
      <logo class="block mx-auto w-full max-w-xs text-white fill-current" height="50" />
      <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="submit">
        ...
        <div class="px-10 py-4 bg-grey-200 border-t border-grey-400 flex justify-between items-center">
